...
Defined in: [packages/db/src/errors.ts:2](https://github.com/rranjan14/tanstack-db/blob/main/packages/db/src/errors.ts#L2)
...
Defined in: [packages/db/src/errors.ts:3](https://github.com/rranjan14/tanstack-db/blob/main/packages/db/src/errors.ts#L3)
