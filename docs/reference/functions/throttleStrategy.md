...
Defined in: [packages/db/src/strategies/throttleStrategy.ts:48](https://github.com/rranjan14/tanstack-db/blob/main/packages/db/src/strategies/throttleStrategy.ts#L48)
