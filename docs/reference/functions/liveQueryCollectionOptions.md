...
Defined in: [packages/db/src/query/live-query-collection.ts:62](https://github.com/rranjan14/tanstack-db/blob/main/packages/db/src/query/live-query-collection.ts#L62)
