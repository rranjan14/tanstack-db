...
Defined in: [packages/db/src/local-storage.ts:316](https://github.com/rranjan14/tanstack-db/blob/main/packages/db/src/local-storage.ts#L316)
...
Defined in: [packages/db/src/local-storage.ts:336](https://github.com/rranjan14/tanstack-db/blob/main/packages/db/src/local-storage.ts#L336)
