...
Defined in: [packages/db/src/query/expression-helpers.ts:265](https://github.com/rranjan14/tanstack-db/blob/main/packages/db/src/query/expression-helpers.ts#L265)
